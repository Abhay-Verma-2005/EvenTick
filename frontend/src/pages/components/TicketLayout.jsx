    ...
    <div className={`premium-ticket-wrap ${isCancelled ? "ticket-gray" : ""}`}>
      ...
      <div className="pt-left">
        <div className="pt-header">
          ...
          <span className={`pt-badge ${isCancelled ? (ticket.refundStatus === "REFUNDED" ? "pt-badge-refunded" : "pt-badge-cancelled") : "pt-badge-active"}`}>
            {isCancelled ? (ticket.refundStatus === "REFUNDED" ? "Refunded" : "Refund Pending") : "Valid Pass"}
          </span>
        </div>
